...
#include "../SampleClient/DeviceController.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDeviceControllerENDCLASS_t qt_meta_stringdata_CLASSDeviceControllerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(83, 13),  // "errorOccurred"
        QT_MOC_LITERAL(97, 28),  // "QAbstractSocket::SocketError"
        QT_MOC_LITERAL(126, 8),  // "readData"
        QT_MOC_LITERAL(135, 4),  // "data"
        QT_MOC_LITERAL(140, 19),  // "socket_stateChanged"
        QT_MOC_LITERAL(160, 5),  // "state"
        QT_MOC_LITERAL(166, 9)   // "readReady"
    },
    "DeviceController",
    "connected",
    "",
...
void DeviceController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &DeviceController::readData; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void DeviceController::readData(QByteArray _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
