...
#include "../ServerSample/mytcpserver.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTCPServerENDCLASS_t qt_meta_stringdata_CLASSMyTCPServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 15),  // "clientDataReady"
        QT_MOC_LITERAL(48, 4),  // "data"
        QT_MOC_LITERAL(53, 19),  // "client_Disconnected"
        QT_MOC_LITERAL(73, 18),  // "onClientConnecting"
        QT_MOC_LITERAL(92, 9),  // "readyRead"
        QT_MOC_LITERAL(102, 18)   // "clientDisconnected"
    },
    "MyTCPServer",
    "newClientConnected",
    "",
...
void MyTCPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->clientDataReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        }
        {
            ...
            if (_t _q_method = &MyTCPServer::clientDataReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyTCPServer::*)();
            if (_t _q_method = &MyTCPServer::client_Disconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void MyTCPServer::clientDataReady(QString _t1)
{
